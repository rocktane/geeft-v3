      ...
      parameters: {
        ...
        messages: [{
          ...
          content: <<~PROMPT
            ...
            - Ta réponse doit consister uniquement en une nouvelle liste numérotée de trente cadeaux. Chaque cadeau doit être sur une nouvelle ligne et numéroté de 1 à 30. Aucun autre texte ne doit être inclus.
          PROMPT
        }]
      }
    )
